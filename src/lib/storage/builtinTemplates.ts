...
export const BUILTIN_DRUM_TEMPLATES: BuiltInTemplate[] = [
    ...
    {
        id: 'hip-hop-boom-bap',
        slug: 'hip-hop-boom-bap',
        name: 'Boom Bap Hip-Hop',
        type: 'drums',
        description: 'Classic 90s hip-hop boom bap pattern with swing.',
        longDescription: 'The classic boom bap sound that defined 90s hip-hop. Features a punchy kick, crisp snare on 2 and 4, and swung hi-hats. Essential for old-school hip-hop productions.',
        bpm: 90,
        bars: 2,
        timeSignature: [4, 4],
        key: 'C',
        ...
        notes: [
            // Bar 1
            { pitch: 36, startBeat: 0, duration: 0.5, velocity: 110 },    // Kick
            { pitch: 42, startBeat: 0, duration: 0.125, velocity: 70 },   // Hi-hat
            { pitch: 42, startBeat: 0.375, duration: 0.125, velocity: 60 }, // Hi-hat (swung)
            { pitch: 42, startBeat: 0.5, duration: 0.125, velocity: 70 },
            { pitch: 42, startBeat: 0.875, duration: 0.125, velocity: 60 },
            { pitch: 38, startBeat: 1, duration: 0.5, velocity: 100 },    // Snare
            ...
            { pitch: 36, startBeat: 1.75, duration: 0.25, velocity: 90 }, // Kick
            { pitch: 42, startBeat: 1.875, duration: 0.125, velocity: 60 },
            { pitch: 42, startBeat: 2, duration: 0.125, velocity: 70 },
            { pitch: 42, startBeat: 2.375, duration: 0.125, velocity: 60 },
            { pitch: 36, startBeat: 2.5, duration: 0.5, velocity: 100 },  // Kick
            { pitch: 42, startBeat: 2.5, duration: 0.125, velocity: 70 },
            { pitch: 42, startBeat: 2.875, duration: 0.125, velocity: 60 },
            { pitch: 38, startBeat: 3, duration: 0.5, velocity: 100 },    // Snare
            ...
            { pitch: 42, startBeat: 3.875, duration: 0.125, velocity: 60 },
            // Bar 2
            { pitch: 36, startBeat: 4, duration: 0.5, velocity: 110 },
            { pitch: 42, startBeat: 4, duration: 0.125, velocity: 70 },
            { pitch: 42, startBeat: 4.375, duration: 0.125, velocity: 60 },
            { pitch: 42, startBeat: 4.5, duration: 0.125, velocity: 70 },
            { pitch: 42, startBeat: 4.875, duration: 0.125, velocity: 60 },
            { pitch: 38, startBeat: 5, duration: 0.5, velocity: 100 },
            { pitch: 42, startBeat: 5, duration: 0.125, velocity: 75 },
            { pitch: 42, startBeat: 5.375, duration: 0.125, velocity: 60 },
            { pitch: 42, startBeat: 5.5, duration: 0.125, velocity: 70 },
            { pitch: 36, startBeat: 5.75, duration: 0.25, velocity: 90 },
            { pitch: 42, startBeat: 5.875, duration: 0.125, velocity: 60 },
            { pitch: 42, startBeat: 6, duration: 0.125, velocity: 70 },
            { pitch: 42, startBeat: 6.375, duration: 0.125, velocity: 60 },
            { pitch: 36, startBeat: 6.5, duration: 0.5, velocity: 100 },
            { pitch: 42, startBeat: 6.5, duration: 0.125, velocity: 70 },
            { pitch: 42, startBeat: 6.875, duration: 0.125, velocity: 60 },
            { pitch: 38, startBeat: 7, duration: 0.5, velocity: 100 },
            { pitch: 42, startBeat: 7, duration: 0.125, velocity: 75 },
            { pitch: 46, startBeat: 7.5, duration: 0.25, velocity: 85 },  // Open hi-hat
        ],
        tags: ['hip-hop', 'boom-bap', '90s', 'rap', 'old-school'],
        genre: 'Hip-Hop',
        difficulty: 'intermediate',
        relatedTemplates: ['trap-808-pattern', 'syncopated-funk'],
        createdAt: '2024-01-01T00:00:00Z',
        author: 'ProducerHub',
    },
    {
        ...
        longDescription: 'A hard-hitting trap pattern with rapid hi-hat rolls, sparse 808 kicks, and crisp claps. Essential for modern trap, hip-hop, and bass music productions.',
        bpm: 145,
        bars: 2,
        timeSignature: [4, 4],
        key: 'C',
        ...
        notes: [
            // Bar 1
            { pitch: 36, startBeat: 0, duration: 0.75, velocity: 127 },   // 808 Kick (sustained)
            ...
            { pitch: 39, startBeat: 1, duration: 0.25, velocity: 100 },   // Clap
            { pitch: 42, startBeat: 1, duration: 0.125, velocity: 75 },
            { pitch: 42, startBeat: 1.125, duration: 0.125, velocity: 50 }, // Roll
        ...
        tags: ['trap', '808', 'hi-hat-rolls', 'modern', 'bass-music'],
        genre: 'Trap',
        difficulty: 'advanced',
        relatedTemplates: ['hip-hop-boom-bap', 'four-on-the-floor'],
        createdAt: '2024-01-01T00:00:00Z',
        author: 'ProducerHub',
    },
    {
        ...
        longDescription: 'A classic jungle breakbeat at 170 BPM featuring the iconic amen break style. Syncopated kicks, rolling snares, and choppy hi-hats create that authentic jungle energy.',
        bpm: 170,
        bars: 2,
        timeSignature: [4, 4],
        key: 'C',
        ...
        notes: [
            // Bar 1 - Classic breakbeat pattern
            ...
            { pitch: 42, startBeat: 7, duration: 0.125, velocity: 85 },
            ...
            { pitch: 38, startBeat: 7.875, duration: 0.125, velocity: 110 }, // Snare roll fill
        ],
        tags: ['jungle', 'dnb', 'breakbeat', 'amen', 'drum-and-bass'],
        genre: 'DnB',
        difficulty: 'advanced',
        relatedTemplates: ['four-on-the-floor', 'syncopated-funk'],
        createdAt: '2024-01-01T00:00:00Z',
    ...
    {
        id: 'reggae-one-drop',
        slug: 'reggae-one-drop',
        name: 'Reggae One Drop',
        type: 'drums',
        description: 'Classic reggae one-drop pattern with emphasis on beat 3.',
        longDescription: 'The iconic one-drop reggae rhythm where the kick and snare hit together on beat 3, creating that laid-back island groove. Hi-hats play steady eighths with rimshots accenting the offbeats.',
        bpm: 75,
        bars: 2,
        timeSignature: [4, 4],
        key: 'C',
        ...
        notes: [
            ...
            { pitch: 37, startBeat: 0.5, duration: 0.25, velocity: 70 },  // Rim shot
            { pitch: 42, startBeat: 0.5, duration: 0.25, velocity: 70 },
            { pitch: 42, startBeat: 1, duration: 0.25, velocity: 75 },
            { pitch: 37, startBeat: 1.5, duration: 0.25, velocity: 70 },
            { pitch: 42, startBeat: 1.5, duration: 0.25, velocity: 70 },
            { pitch: 36, startBeat: 2, duration: 0.5, velocity: 100 },    // Kick + Snare (one-drop)
            { pitch: 38, startBeat: 2, duration: 0.5, velocity: 100 },
            { pitch: 42, startBeat: 2, duration: 0.25, velocity: 80 },
            { pitch: 37, startBeat: 2.5, duration: 0.25, velocity: 70 },
            { pitch: 42, startBeat: 2.5, duration: 0.25, velocity: 70 },
            { pitch: 42, startBeat: 3, duration: 0.25, velocity: 75 },
            { pitch: 37, startBeat: 3.5, duration: 0.25, velocity: 70 },
            { pitch: 42, startBeat: 3.5, duration: 0.25, velocity: 70 },
            // Bar 2
            { pitch: 42, startBeat: 4, duration: 0.25, velocity: 75 },
            { pitch: 37, startBeat: 4.5, duration: 0.25, velocity: 70 },
            { pitch: 42, startBeat: 4.5, duration: 0.25, velocity: 70 },
            { pitch: 42, startBeat: 5, duration: 0.25, velocity: 75 },
            { pitch: 37, startBeat: 5.5, duration: 0.25, velocity: 70 },
            { pitch: 42, startBeat: 5.5, duration: 0.25, velocity: 70 },
            { pitch: 36, startBeat: 6, duration: 0.5, velocity: 100 },
            { pitch: 38, startBeat: 6, duration: 0.5, velocity: 100 },
            { pitch: 42, startBeat: 6, duration: 0.25, velocity: 80 },
            { pitch: 37, startBeat: 6.5, duration: 0.25, velocity: 70 },
            { pitch: 42, startBeat: 6.5, duration: 0.25, velocity: 70 },
            { pitch: 42, startBeat: 7, duration: 0.25, velocity: 75 },
            { pitch: 37, startBeat: 7.5, duration: 0.25, velocity: 70 },
            { pitch: 46, startBeat: 7.5, duration: 0.25, velocity: 80 },  // Open hi-hat
        ],
        tags: ['reggae', 'one-drop', 'caribbean', 'dub', 'island'],
        genre: 'Reggae',
        difficulty: 'beginner',
        relatedTemplates: ['syncopated-funk', 'basic-rock-beat'],
        createdAt: '2024-01-01T00:00:00Z',
        author: 'ProducerHub',
    },
    {
        id: 'latin-bossa-nova',
        slug: 'latin-bossa-nova',
        name: 'Bossa Nova',
        type: 'drums',
        description: 'Smooth Brazilian bossa nova rhythm with brushes feel.',
        longDescription: 'A gentle bossa nova pattern inspired by João Gilberto and Brazilian jazz. Light kick accents, cross-stick on the snare, and a flowing hi-hat pattern create the signature smooth groove.',
        bpm: 130,
        bars: 2,
        timeSignature: [4, 4],
        key: 'C',
        ...
        notes: [
            // Bar 1 - Classic bossa nova pattern
            { pitch: 36, startBeat: 0, duration: 0.25, velocity: 80 },
            { pitch: 42, startBeat: 0, duration: 0.125, velocity: 60 },
            { pitch: 42, startBeat: 0.25, duration: 0.125, velocity: 55 },
            { pitch: 42, startBeat: 0.5, duration: 0.125, velocity: 65 },
            { pitch: 37, startBeat: 0.75, duration: 0.25, velocity: 75 }, // Cross-stick
            { pitch: 42, startBeat: 0.75, duration: 0.125, velocity: 55 },
            { pitch: 42, startBeat: 1, duration: 0.125, velocity: 60 },
            { pitch: 42, startBeat: 1.25, duration: 0.125, velocity: 55 },
            { pitch: 36, startBeat: 1.5, duration: 0.25, velocity: 75 },
            { pitch: 42, startBeat: 1.5, duration: 0.125, velocity: 65 },
            { pitch: 42, startBeat: 1.75, duration: 0.125, velocity: 55 },
            { pitch: 42, startBeat: 2, duration: 0.125, velocity: 60 },
            { pitch: 37, startBeat: 2.25, duration: 0.25, velocity: 75 },
            { pitch: 42, startBeat: 2.25, duration: 0.125, velocity: 55 },
            { pitch: 42, startBeat: 2.5, duration: 0.125, velocity: 60 },
            { pitch: 42, startBeat: 2.75, duration: 0.125, velocity: 55 },
            { pitch: 36, startBeat: 3, duration: 0.25, velocity: 80 },
            { pitch: 42, startBeat: 3, duration: 0.125, velocity: 65 },
            { pitch: 42, startBeat: 3.25, duration: 0.125, velocity: 55 },
            { pitch: 42, startBeat: 3.5, duration: 0.125, velocity: 60 },
            { pitch: 37, startBeat: 3.75, duration: 0.25, velocity: 75 },
            { pitch: 42, startBeat: 3.75, duration: 0.125, velocity: 55 },
            // Bar 2
            { pitch: 42, startBeat: 4, duration: 0.125, velocity: 60 },
            { pitch: 42, startBeat: 4.25, duration: 0.125, velocity: 55 },
            { pitch: 36, startBeat: 4.5, duration: 0.25, velocity: 75 },
            { pitch: 42, startBeat: 4.5, duration: 0.125, velocity: 65 },
            { pitch: 42, startBeat: 4.75, duration: 0.125, velocity: 55 },
            { pitch: 42, startBeat: 5, duration: 0.125, velocity: 60 },
            { pitch: 37, startBeat: 5.25, duration: 0.25, velocity: 75 },
            { pitch: 42, startBeat: 5.25, duration: 0.125, velocity: 55 },
            { pitch: 42, startBeat: 5.5, duration: 0.125, velocity: 60 },
            { pitch: 42, startBeat: 5.75, duration: 0.125, velocity: 55 },
            { pitch: 36, startBeat: 6, duration: 0.25, velocity: 80 },
            { pitch: 42, startBeat: 6, duration: 0.125, velocity: 65 },
            { pitch: 42, startBeat: 6.25, duration: 0.125, velocity: 55 },
            { pitch: 42, startBeat: 6.5, duration: 0.125, velocity: 60 },
            { pitch: 37, startBeat: 6.75, duration: 0.25, velocity: 75 },
            { pitch: 42, startBeat: 6.75, duration: 0.125, velocity: 55 },
            { pitch: 42, startBeat: 7, duration: 0.125, velocity: 60 },
            { pitch: 36, startBeat: 7.25, duration: 0.25, velocity: 75 },
            { pitch: 42, startBeat: 7.25, duration: 0.125, velocity: 55 },
            { pitch: 42, startBeat: 7.5, duration: 0.125, velocity: 60 },
            { pitch: 42, startBeat: 7.75, duration: 0.125, velocity: 55 },
        ],
        tags: ['bossa-nova', 'brazilian', 'jazz', 'latin', 'smooth'],
        genre: 'Latin',
        difficulty: 'intermediate',
        relatedTemplates: ['syncopated-funk', 'reggae-one-drop'],
        createdAt: '2024-01-01T00:00:00Z',
        author: 'ProducerHub',
    },
    {
        ...
        longDescription: 'The quintessential disco groove featuring a driving four-on-the-floor kick, snares on 2 and 4, and the signature open hi-hat on the off-beats. Essential for disco, nu-disco, and funk productions.',
        bpm: 120,
        bars: 2,
        timeSignature: [4, 4],
        key: 'C',
        ...
        notes: [
            ...
            { pitch: 46, startBeat: 0.5, duration: 0.25, velocity: 90 },  // Open hi-hat
            { pitch: 36, startBeat: 1, duration: 0.5, velocity: 100 },
            { pitch: 38, startBeat: 1, duration: 0.5, velocity: 100 },
